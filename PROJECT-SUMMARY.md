...
**本地**: D:\Project\Xiyue  
**远程**: 待设置（https://github.com/Longtiverse/Xiyue.git）

**最新提交**:
- `b523f52` - fix: resolve compilation errors in UI components
- `ca04a6a` - feat: complete UI iteration with design system

**最新 APK**:
- `builds/android/latest/xiyue-android-v0.1.0-20260408-0009-debug.apk`
