...
test('android home persists last selection, display settings, and recent items', () => {
  ...
  assert.match(repository, /TonePreset\.PIANO/);
  assert.match(repository, /displayMode/);
  assert.match(repository, /durationMultiplier/);
  assert.match(repository, /KEY_DURATION_MULTIPLIER/);
  ...
  assert.match(app, /durationMultiplier = initialPreferences\.durationMultiplier/);
  assert.match(app, /durationMultiplier = state\.durationMultiplier/);
  assert.match(app, /state\.durationMultiplier/);
  ...
  assert.match(factory, /durationMultiplier = durationMultiplier/);
